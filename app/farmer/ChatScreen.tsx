...
const ChatScreen = () => {
  ...
  const { expertId, expertName } = route.params as any;
      ...
      headerTitle: () => (
        <View style={styles.headerTitle}>
          ...
          <View>
            ...
            <Text style={styles.expertStatus}>{t('online')}</Text>
          </View>
        </View>
      ),
      headerLeft: () => (
  ...
  const renderMessage = ({ item }: { item: Message }) => (
    <View style={[
      ...
      item.sender === 'farmer' ? styles.sentMessage : styles.receivedMessage
    ]}>
      {item.type === 'text' && (
